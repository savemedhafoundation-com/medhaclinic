    ...
    <div className="flex flex-col gap-6 md:grid md:grid-cols-[1.5fr_1fr_1fr_1fr] md:gap-8">
        ...
        <div className="mt-3 flex flex-col gap-2 text-white md:text-[15px]">
          {legalLinks.map((item) => (
            item.to ? (
              ...
              <span key={item.label} className="text-white/75">
                {item.label}
              </span>
            )
          ))}
      ...
      <div>
        ...
        <div className="mt-3 space-y-2 text-white/90 md:text-[15px]">
          <a href="tel:+919800808595" className="block hover:text-white">
            +91 98008 08595
          </a>
          <a href="mailto:info@medhaclinic.com" className="block hover:text-white">
            info@medhaclinic.com
          </a>
          <p>
